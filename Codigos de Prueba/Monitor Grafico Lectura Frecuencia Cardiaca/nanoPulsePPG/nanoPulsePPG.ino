...
void draw_oled(int msg) {
    ...
    switch(msg){
        case 0:  oled.drawStr(10,0,F("Device error"),1); 
                 break;
        case 1:  oled.drawStr(13,10,F("Colocar"),1); 
                 oled.drawStr(10,20,F("  Dedo"),1);
        ...
        case 2:  print_digit(86,0,beatAvg);
                 ...
                 break;
        case 3:  oled.drawStr(30,9,F(""),1);
                 oled.drawStr(30,20,F("    HOLA!    "),1);
                 //oled.drawXBMP(6,8,16,16,heart_bits);
                
                 break;
        case 4:  oled.drawStr(28,12,F("OFF EN"),1);
